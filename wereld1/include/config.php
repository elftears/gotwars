...
$config['db_host'] = 'lhttp://192.99.212.204'; // Host of the Database
$config['db_user'] = 'got'; // Database username
$config['db_pw'] = 'admin09'; // Database Password
...
$config['global_db'] = 'db'; // DATABASE name!
